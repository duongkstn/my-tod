...
MODEL_CLASSES = {
    ...
    "phobert": (RobertaConfig, RobertaForMaskedLM, PhobertTokenizer),
...
def mask_for_response_selection(batch, tokenizer, args, cand_uttr_sys_dict, others, set_max_resp_len=150, set_max_context_len=256):
    ...
    max_last_sys_position = min(set_max_context_len, max(last_sys_position))
    ...
    for bsz_i, (sys_pos, usr_pos) in enumerate(zip(last_sys_position, last_usr_position)):
        input_contexts[bsz_i, :sys_pos] = inputs[bsz_i, :sys_pos][-set_max_context_len:]
...
def train(args, trn_loader, dev_loader, model, tokenizer, cand_uttr_sys_dict, others):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if args.add_rs_loss:
                ...
                input_cont, input_resp, resp_label = mask_for_response_selection(
                    ...
                    set_max_context_len=256 if args.model_type in ["phobert", "roberta"] else 512
                )
                ...
                if args.model_type in ["phobert", "roberta"]:
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.save_steps > 0 and global_step % args.save_steps == 0:
                    print('Division by args.save_steps')
        ...
        if (global_step > args.max_steps > 0) or patience > args.patience:
...
def main():
    ...
    parser.add_argument("--use_tpu", action="store_true", help="TPU")
    parser.add_argument(
