...
def read_langs_turn(args, file_name, max_line=None, ds_name=""):
    ...
    with open(file_name) as f:
        ...
        for dial_dict in dials:
            ...
            for ti, turn in enumerate(dial_dict["dialogue"]):
                ...
                need_translate.extend([turn["transcript"], turn["system_transcript"]])
    ...
    pd.DataFrame({"text": need_translate}).to_excel(
        "/home/duongkstn/ToD-BERT/utils/train_dumpdata_tod_woz.xlsx", index=False
    )
    # exit(0)
    return data
