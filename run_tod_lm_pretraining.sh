...
#--data_path=/media/user/Data/ToD-BERT/TODBERT_dialog_datasets/dialog_datasets/ --task=usdl --model_type=bert --model_name_or_path=bert-base-uncased --dataset=metalwoz --output_dir=./output_dir --do_train --mlm --do_lower_case --per_gpu_train_batch_size=8 --add_rs_loss --cache_dir=/media/user/Data/phobert_embedding_service/cache_dir_bert_base_uncased